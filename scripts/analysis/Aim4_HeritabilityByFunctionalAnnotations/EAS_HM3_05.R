...
system(paste0("ldsc.py",
              ...
              " --ref-ld-chr /data/williamsjacr/Aim4_PartitionedHeritability/LDSC_Files/EAS_Baseline/baselineLD.", 
              " --frqfile-chr /data/williamsjacr/Aim4_PartitionedHeritability/LDSC_Files/1000G_Phase3_EAS_plinkfiles/1000G.EAS.QC.",  
              " --overlap-annot",
              " --out /data/williamsjacr/Aim4_PartitionedHeritability/Results/EAS_05_HM3_Their_LDSC",  
              " --print-cov --print-coefficients --print-delete-vals"))

system(paste0("ldsc.py",
              " --h2 /data/williamsjacr/Aim4_PartitionedHeritability/Intermediate_Files/sum_align.sumstats.gz",
              " --w-ld-chr /data/williamsjacr/1KG_ldsc_HM3/EAS/EAS_hm3_ldsc/",
              " --ref-ld-chr /data/williamsjacr/1KG_Partitioned_LDSC_HM3/EAS/EAS_hm3_ldsc/baselineLD.", 
              " --frqfile-chr /data/williamsjacr/1KG_Partitioned_LDSC_HM3/EAS/chr_clean",  
              " --overlap-annot",
              " --out /data/williamsjacr/Aim4_PartitionedHeritability/Results/EAS_05_HM3_My_LDSC",  
              " --print-cov --print-coefficients --print-delete-vals"))