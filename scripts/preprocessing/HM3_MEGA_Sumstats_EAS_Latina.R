# dx run app-swiss-army-knife -iin=PreConfluenceAnalysis:Aim1_Heritability/JacobWilliams/Clean_Data_Scripts/r_with_plink.tar.gz -iin=PreConfluenceAnalysis:Aim1_Heritability/JacobWilliams/Clean_Data_Scripts/HM3_MEGA_Sumstats_EAS_Latina.R -iin=PreConfluenceAnalysis:Aim1_Heritability/JacobWilliams/Clean_Data_Scripts/HM3_MEGA_Sumstats_EAS_Latina.sh -iin=PreConfluenceData:BCAC_Asian/bcac_asian_icogs_onco_erneg_meta1.txt.gz -iin=PreConfluenceData:Latina_Summary_Results/Result_merged_ucsf_kp_mec_cama_allchr.txt -iin=PreConfluenceData:BCAC_Asian/bcac_asian_icogs_onco_erpos_meta1.txt.gz -icmd="bash HM3_MEGA_Sumstats_EAS_Latina.sh" -y --destination PreConfluenceAnalysis:Aim2_Polygenicity/HZ/Results/Clean_summary_data_update/ --instance-type mem1_ssd1_v2_x36
...
rm(list=setdiff(ls(), c("hm3_mega","merge_data")))
...
bcac_erneg_update_hm3 <-  bcac_erneg_update %>% 
  ...
  filter(unique_SNP_id %in% hm3_mega$rsid) 
...
write.table(bcac_erneg_sub_quan, file = "EAS_ERNeg_HM3_MEGA_01.txt", row.names = F, col.names = T, quote = F)
...
write.table(bcac_erneg_sub_quan, file = "EAS_ERNeg_HM3_MEGA_05.txt", row.names = F, col.names = T, quote = F)
...
write.table(bcac_erpos_sub_quan, file = "EAS_ERPos_HM3_MEGA_01.txt", row.names = F, col.names = T, quote = F)
...
write.table(bcac_erpos_sub_quan, file = "EAS_ERPos_HM3_MEGA_05.txt", row.names = F, col.names = T, quote = F)
...
write.table(latina_overall_sub_quan, file = "Latina_Overall_HM3_MEGA_01.txt", row.names = F, col.names = T, quote = F)
...
write.table(latina_overall_sub_quan, file = "Latina_Overall_HM3_MEGA_05.txt", row.names = F, col.names = T, quote = F)
...
system("rm snpinfo_hm3_mega.csv")